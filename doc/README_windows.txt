...
Copyright (c) 2013-2014 OHLCcoin Developers
...
Intro
-----
OHLCcoin is a free open source project derived from NovaCoin, with
...
incoming connections.  OHLCcoin works without incoming connections,
but allowing incoming connections helps the OHLCcoin network.
...
See the documentation/wiki at the OHLCcoin site:
  http://cloakcoin.cc/
